    ...
    if age is not None: 
        ...
        if age <= 0:
            return build_validation_result(
                False, 
                'age', 
                'Age input is invalid, please provide a valid age'
            )
        if age > 65: 
            return build_validation_result(
                False, 
                'age', 
                'I apolozie, your age is beyond the limits of my abilities, '
                'please provide a different age'
            )
    # Validate Investment Amount, it should be at least 5000
    if investmentAmount is not None: 
        ...
        if investmentAmount < 5000: 
            return  build_validation_result(
                False, 
                'investmentAmount', 
                'Your initial invesment must be at least $5000, '
                'please provide a different amount to invest.'
            )
    # If age and investment meet requirements, return true
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        # Validate user's input using the validate_data()
        ...
        if not validation_result['isValid']: 
            ...
            # Return n elicitSlot dialog to request new data for the invalid slot
            return elicit_slot(
